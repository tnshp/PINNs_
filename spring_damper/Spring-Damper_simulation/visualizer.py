...
class Visualizer(object):
    def __init__(self, callback=None, interval=100.0, simulation_time=20.0, initial=(0, 0, 0, 0, 0, 0), sample_prob = 0.1, filename = 'DATA\data.csv'):
        # Set loop interval
    ...
    def animate(self, i):
        ...
        if random.random() > (1 - self.sample_prob) :
            with open(self.filename, 'a', newline='') as csvfile:
                csvwriter = csv.writer(csvfile) 
                csvwriter.writerow([x, y, vx, vy, self.sim_time]) 
